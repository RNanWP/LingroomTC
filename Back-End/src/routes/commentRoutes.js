...
router.post("/comments/:commentId/reply", auth_1.authenticate, (0, auth_1.authorize)("professor", "administrador"), (0, asyncHandler_1.asyncHandler)(commentController.createReply));
